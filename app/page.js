...
//       <h1 className="text-3xl font-bold underline">Soy</h1>
//     </div>
//   );
// }
      ...
      {/* <section className="py-16 px-4 bg-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white p-6 rounded-md shadow-md text-center">
            ...
            <p>
              Aumenta tu presencia online con estrategias efectivas en redes
              sociales.
            </p>
          </div>
          <div className="bg-white p-6 rounded-md shadow-md text-center">
            <h3 className="text-xl font-semibold mb-2">SEO y SEM</h3>
            <p>
              Optimiza tu sitio web para atraer más tráfico y convertir visitas
              en clientes.
            </p>
          </div>
          <div className="bg-white p-6 rounded-md shadow-md text-center">
            ...
            <p>
              Conecta con tus clientes y genera ventas a través de campañas de
              email.
            </p>
          </div>
        </div>
